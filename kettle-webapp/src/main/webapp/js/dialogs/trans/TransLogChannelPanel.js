TransLogChannelPanel = Ext.extend(Ext.Panel, {
	...
	initComponent: function() {
		...
		var grid = new Ext.grid.EditorGridPanel({
			...
			store: new Ext.data.JsonStore({
				...
				data: channelLogTable.fields
			})
		});
		
		this.items = [form, grid];
		
		TransLogChannelPanel.superclass.initComponent.call(this);
	}

});

Ext.reg('TransLogChannel', TransLogChannelPanel);