TransLogStepPanel = Ext.extend(Ext.Panel, {
	...
	initComponent: function() {
		...
		var stepLogTable = Ext.decode(root.getAttribute('stepLogTable'));
		...
		var grid = new Ext.grid.EditorGridPanel({
			...
			store: new Ext.data.JsonStore({
				...
				data: stepLogTable.fields
			})
		});
		this.items = [form, grid];
		TransLogStepPanel.superclass.initComponent.call(this);
	}

});

Ext.reg('TransLogStep', TransLogStepPanel);